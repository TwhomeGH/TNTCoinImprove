 ...
 */
export async function fill(dimension, blockName, blockLocations, chunkSize, fillSettings = {}) {
    ...
    try {
        await batch(blockLocations, chunkSize, setBlock, {
